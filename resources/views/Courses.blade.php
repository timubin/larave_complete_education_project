...
<div id="mainDivCourse" class="container d-none">
    ...
    <div class="col-md-12 p-5">
        <button id="addNewCourseBunId" class="btn my-3 btn-sm btn-danger">Add New </button>
...
<div class="modal-dialog modal-lg" role="document">
  ...
  <div class="modal-header">
    ...
    <h5 id="courseEditId" class="mt-4 d-none"></h5>
     ...
     <img id="courseEditLoader" class="loading-icon m-5" src="{{asset('images/loder.svg')}}" alt="">
     <h4  id="courseEditWrong" class="d-none">Somthing Went Wrong !</h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button  id="CourseDeleteConfirmBtn" type="button" class="btn btn-sm btn-danger">
          Yes
        </button>
      </div>
    </div>
...
function getCoursesData(){
      ...
      $.each(jsonData,function(i,item){
        $("<tr>").html(
         ...
         $(document).ready(function () {
          $('#classDataTable').DataTable({"order":false});
  ...
  $('#addNewCourseBunId').click(function(){
...
function CourseAdd(CourseName,CourseDes,CourseFee,CourseEnroll,CourseClass,CourseLink,CourseImg){
  ...
  if(CourseName.length==0){
   toastr.error("Courses Name is Empty");
 }
 
 else if(CourseDes.length==0){
   toastr.error("Courses Description is Empty");
 }
 else if(CourseFee.length==0){
   toastr.error("Courses Fee is Empty");
 }
   ...
   $('#CourseAddConfirmBtn').html("<div class='spinner-border spinner-border-sm' role='status'></div>"); //Animition......
...
function CourseDelete(deleteID){
  $('#CourseDeleteConfirmBtn').html("<div class='spinner-border spinner-border-sm' role='status'></div>"); //Animition......
 ...
 function CourseUpdate(courseID,courseName,courseDes,courseFee,courseEnroll,courseClass,courseLink,courseImg){
  ...
  if(courseName.length==0){
   ...
   $('#CourseUpdateConfirmBtn').html("<div class='spinner-border spinner-border-sm' role='status'></div>"); //Animition......
